 ...
 * 
 * This middleware intercepts requests to /api/* paths and forwards them to
 * the Flask backend server, acting as a proxy.
 * 
 * @param context - The Astro middleware context
 * @param next - Function to continue to the next middleware or route handler
 * @returns Response from the backend API or error response
 */
